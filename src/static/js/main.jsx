                ...
                <Form>
                    ...
                    <FormGroup id={"upload_button"}>
                        ...
                        <Label for="imageUpload">
                            ...
                            <span className="btn btn-primary">上传</span>
                        </Label>
                    </FormGroup>
                    ...
                    <FormGroup>
                        <Button color="success" onClick={this._predict}
                                disabled={this.state.isLoading}> 识别</Button>
                        <span className="p-1 "/>
                        <Button color="danger" onClick={this._clear}> 清除</Button>
                    </FormGroup>
            ...
            <Navbar color="light" light fixed expand="md">
                ...
                <Collapse navbar>
                    <Nav className="ml-auto" navbar>
                        ...
                        <NavItem>
                            <NavLink href={link}>GitHub仓库</NavLink>
                        </NavItem>
